...
proof fn always_tla_forall_apply_for_sub_resource(spec: TempPred<FBCluster>, sub_resource: SubResource, fb: FluentBitView)
    requires
        ...
        spec.entails(always(tla_forall(|res: SubResource| lift_state(helper_invariants::no_create_resource_request_msg_without_name_in_flight(res, fb))))),
    ensures
        ...
        spec.entails(always(lift_state(helper_invariants::no_create_resource_request_msg_without_name_in_flight(sub_resource, fb)))),
{
    ...
    always_tla_forall_apply(spec, |res: SubResource| lift_state(helper_invariants::no_create_resource_request_msg_without_name_in_flight(res, fb)), sub_resource);
}
